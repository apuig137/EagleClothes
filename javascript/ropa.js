...
let layoutAcerca = document.querySelector(".layout-acerca")
let layoutImg = document.querySelector(".layout-img")
...
let btnAcerca = document.querySelector("#acerca-btn")
...
let mostrarDisplayRopa = () => {
    ...
    layoutAcerca.classList.add("display-none")
    layoutImg.classList.add("display-none")
}
...
let mostrarDisplayInicio = () => {
    ...
    layoutRelojes.classList.add("display-none")
    layoutAcerca.classList.add("display-none")
    layoutImg.classList.remove("display-none")
}
let mostrarDisplayAcerca = () => {
    layoutIndex.classList.add("display-none")
    layoutRopa.classList.add("display-none")
    layoutPerfumes.classList.add("display-none")
    layoutRelojes.classList.add("display-none")
    layoutAcerca.classList.remove("display-none")
    layoutImg.classList.add("display-none")
}
